...
_`PYTHON`_ _`PYSIDE`_ _`QT_DESIGNER`_  

Приложения написаны на _`PYTHON`_ с использованием библиотеки _`PYSIDE`_ для создания интерфейса.
